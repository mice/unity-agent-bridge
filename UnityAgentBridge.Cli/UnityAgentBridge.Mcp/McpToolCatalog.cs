...
public static class McpToolCatalog
{
    ...
    private static IEnumerable<ToolMetadata> CreateUnityBridgeForwardedTools()
    {
        ...
        yield return CreateToolMetadata("mcp__unity__get_console", "Unity Console", "Call unity.get_console through the Unity Agent Bridge CLI.", """{"type":"object","properties":{"types":{"minItems":1,"maxItems":3,"type":"array","items":{"type":"string","enum":["error","warning","info"]}},"count":{"type":"integer","minimum":0,"maximum":1000},"timeoutMs":{"type":"integer","minimum":1,"maximum":9007199254740991}},"required":["types"],"$schema":"http://json-schema.org/draft-07/schema#","additionalProperties":false}""", "unity.get_console", 10000);
        yield return CreateToolMetadata("mcp__unity__assetdatabase_search", "Unity AssetDatabase Search", "Call unity.assetdatabase_search through the Unity Agent Bridge CLI.", """{"type":"object","properties":{"query":{"type":"string","minLength":1},"folders":{"type":"array","items":{"type":"string","minLength":1}},"offset":{"type":"integer","minimum":0,"maximum":9007199254740991},"limit":{"type":"integer","minimum":1,"maximum":200},"includeDetails":{"type":"boolean"}},"required":["query"],"$schema":"http://json-schema.org/draft-07/schema#","additionalProperties":false}""", "unity.assetdatabase_search", 10000);
        ...
        yield return CreateToolMetadata("mcp__unity__get_hierarchy", "Unity Get Hierarchy", "Call unity.get_hierarchy through the Unity Agent Bridge CLI.", """{"type":"object","properties":{"locator":{"anyOf":[{"type":"string"},{"type":"null"}]},"maxDepth":{"type":"integer","minimum":0,"maximum":9007199254740991},"limit":{"type":"integer","minimum":1,"maximum":5000},"includeComponents":{"type":"boolean"},"timeoutMs":{"type":"integer","minimum":1,"maximum":9007199254740991}},"$schema":"http://json-schema.org/draft-07/schema#","additionalProperties":false}""", "unity.get_hierarchy", 10000);
        yield return CreateToolMetadata("mcp__unity__read_report", "Unity Read Report", "Call unity.read_report through the Unity Agent Bridge CLI.", """{"type":"object","properties":{"reportPath":{"type":"string","minLength":1},"jsonPointer":{"type":"string"},"offset":{"type":"integer","minimum":0,"maximum":9007199254740991},"limit":{"type":"integer","minimum":1,"maximum":500},"maxBytes":{"type":"integer","minimum":1,"maximum":262144},"timeoutMs":{"type":"integer","minimum":1,"maximum":9007199254740991}},"required":["reportPath"],"$schema":"http://json-schema.org/draft-07/schema#","additionalProperties":false}""", "unity.read_report", 10000);
        yield return CreateToolMetadata("mcp__unity__get_selection_info", "Unity Selection Info", "Call unity.get_selection_info through the Unity Agent Bridge CLI.", """{"type":"object","properties":{"includeDetails":{"type":"boolean"}},"$schema":"http://json-schema.org/draft-07/schema#","additionalProperties":false}""", "unity.get_selection_info", 10000);
        yield return CreateToolMetadata("mcp__unity__get_gameobject_component_info", "Unity GameObject Component Info", "Call unity.get_gameobject_component_info through the Unity Agent Bridge CLI.", """{"type":"object","properties":{"locator":{"anyOf":[{"type":"string","minLength":1},{"type":"null"}]},"componentName":{"anyOf":[{"type":"string"},{"type":"null"}]},"componentIndex":{"anyOf":[{"type":"integer","minimum":0,"maximum":9007199254740991},{"type":"null"}]},"propertyMode":{"type":"string","enum":["debug","serialized"]},"propertyLimit":{"type":"integer","minimum":0,"maximum":1000},"arrayElementLimit":{"type":"integer","minimum":0,"maximum":200},"stringMaxLength":{"type":"integer","minimum":16,"maximum":4000}},"$schema":"http://json-schema.org/draft-07/schema#","additionalProperties":false}""", "unity.get_gameobject_component_info", 10000);
        ...
        yield return CreateToolMetadata("mcp__unity__run_editmode_tests", "Unity Run EditMode Tests", "Call unity.run_editmode_tests through the Unity Agent Bridge CLI.", """{"type":"object","properties":{"filter":{"type":"string","minLength":1},"testNames":{"type":"array","items":{"type":"string","minLength":1}},"assemblyNames":{"type":"array","items":{"type":"string","minLength":1}},"categoryNames":{"type":"array","items":{"type":"string","minLength":1}},"groupNames":{"type":"array","items":{"type":"string","minLength":1}},"timeoutMs":{"type":"integer","minimum":1,"maximum":9007199254740991}},"$schema":"http://json-schema.org/draft-07/schema#","additionalProperties":false}""", "unity.run_editmode_tests", 120000);
        yield return CreateToolMetadata("mcp__unity__run_playmode_tests", "Unity Run PlayMode Tests", "Call unity.run_playmode_tests through the Unity Agent Bridge CLI.", """{"type":"object","properties":{"filter":{"type":"string","minLength":1},"testNames":{"type":"array","items":{"type":"string","minLength":1}},"assemblyNames":{"type":"array","items":{"type":"string","minLength":1}},"categoryNames":{"type":"array","items":{"type":"string","minLength":1}},"groupNames":{"type":"array","items":{"type":"string","minLength":1}},"timeoutMs":{"type":"integer","minimum":1,"maximum":9007199254740991}},"$schema":"http://json-schema.org/draft-07/schema#","additionalProperties":false}""", "unity.run_playmode_tests", 180000);
        yield return CreateToolMetadata("mcp__unity__agent_bridge_self_test", "Unity Agent Bridge Self-Test", "Run the Agent Bridge self-test suite through the Unity Agent Bridge CLI.", """{"type":"object","properties":{"includeEditModeCase":{"type":"boolean"},"includeDiagnosticCase":{"type":"boolean"},"continueOnFailure":{"type":"boolean"},"timeoutMs":{"type":"integer","minimum":1,"maximum":9007199254740991}},"$schema":"http://json-schema.org/draft-07/schema#","additionalProperties":false}""", "unity.agent_bridge_self_test", 120000);
    }
