...
namespace UnityMcp.AgentBridge
{
    ...
    {
        public static bool TryResolve(string locator, out HierarchyTargetResolution resolution, out ToolResult failure)
        {
            ...
            if (string.Equals(locator, "currentScene", StringComparison.Ordinal))
            {
                ...
                {
                    failure = ToolResult.InvalidArgs("AGENTBRIDGE_SCENE_NOT_LOADED", "Active scene is not open or loaded.");
                    return false;
                }
