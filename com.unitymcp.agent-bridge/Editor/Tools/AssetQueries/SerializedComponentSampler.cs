...
namespace UnityMcp.AgentBridge
{
    internal static class SerializedComponentSampler
    {
        ...
        public static SampleResult Sample(Component component, string propertyMode, int propertyLimit, int arrayElementLimit, int stringMaxLength, IAgentCancellation cancellation)
        {
