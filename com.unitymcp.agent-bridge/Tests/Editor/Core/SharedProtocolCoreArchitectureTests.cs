...
namespace UnityMcp.AgentBridge.Tests
{
    public sealed class SharedProtocolCoreArchitectureTests
    {
        ...
        [Test]
        [Category("AGB_Core")]
        public void McpToolNameMapper_DoesNotOwnAndroidDebuggingPluginNames()
        {
            Assert.That(McpToolNameMapper.TryToCanonicalMcpName("unity.android.debug.status", out _), Is.False);
            Assert.That(McpToolNameMapper.TryToCanonicalMcpName("unity.android.app.start", out _), Is.False);
        }
